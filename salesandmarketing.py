...
m=mysql.connector.connect(host="localhost",user="root",passwd="Novosibirskschalke@123")
c=m.cursor()
...
def salesandmarketing():
    ...
    c.execute("CREATE TABLE if not exists SNM(S_no int(5),Company varchar(15),Model_name varchar(15),Units_sold int(15));")
...
def storelocator():
    ...
    c.execute("CREATE TABLE if not exists SL(St_no int(5),City varchar(15),No_of_Stores int(5),Area varchar(50));")
...
def trackresults():
    ...
    c.execute("CREATE TABLE if not exists CIRCUIT(Circuit varchar(30),Position int(15),Driver varchar(65),Team varchar(25));")
...
def partnerships():
    ...
    c.execute("CREATE TABLE if not exists Partnershipsandsponsors(s_no int(30),Parent_organisation varchar(60),owner varchar(65),Shares_owned_percent int(25));")
